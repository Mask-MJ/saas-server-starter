...
export class DictTypeService {
  ...
  async create(user: ActiveUserData, createDictTypeDto: CreateDictTypeDto) {
    return this.prisma.client.dictType.create({
  ...
  async findOne(id: number) {
    return this.prisma.client.dictType.findUnique({ where: { id } });
  }
  ...
  async update(
    ...
    return this.prisma.client.dictType.update({
      where: { id },
  ...
  async remove(id: number) {
    return this.prisma.client.dictType.delete({ where: { id } });
  }
}
